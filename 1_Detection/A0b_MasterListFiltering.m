...
inppath = "H:\mlBval2Bs166NCe\"; 
inpname = "Bval2Bs166NCe"; 

inpsuffix = "_bcfcall.vcf";

%%% Where do you want to save the master list?
savepath = inppath;
savename = "mlBval2Bs166NCe_v1";

% What filtering parameters would you like to set ?
minTotalCount = 10;     % What is your total count cut off ? (default: 50)
...
excludeIndels = "OFF";   % Do you want to keep indels?
